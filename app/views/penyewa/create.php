...
<body class="bg-gray-100 text-gray-800 antialiased">
    ...
    <div class="container mx-auto px-4 py-10 max-w-3xl mt-20">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-black tracking-tight">Tambah Penyewa</h1>
                <p class="text-gray-500 mt-1 text-sm">Registrasi pelanggan baru.</p>
            </div>
        </div>

        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <form action="<?= BASEURL; ?>/penyewa/simpan" method="POST">
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3" required 
                                  class="w-full border border-gray-200 rounded-xl py-3 px-4 bg-gray-50 focus:bg-white focus:outline-none"></textarea>
                    </div>
